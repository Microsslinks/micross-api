...
const (
	...
	MsgUserAlreadyAgent              = "user.already_agent"
	MsgUserNotAgent                  = "user.not_agent"
	MsgUserAgentHasCustomerCodes     = "user.agent_has_customer_codes"

	// 客户号（客户用经销商发的号绑定自己）
	MsgCustomerCodeNotFound        = "customer_code.not_found"
	MsgCustomerCodeRevoked         = "customer_code.revoked"
	MsgCustomerCodeExpired         = "customer_code.expired"
	MsgCustomerCodeExhausted       = "customer_code.exhausted"
	MsgCustomerCodeAlreadyBound    = "customer_code.already_bound"
	MsgCustomerCodeSelfUse         = "customer_code.self_use"
	MsgCustomerCodeOwnedByAgent    = "customer_code.owned_by_agent"
