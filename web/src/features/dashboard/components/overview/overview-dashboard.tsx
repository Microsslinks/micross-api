    ...
    <div className='flex flex-col gap-4'>
      {setupGuideExpanded ? (
        <CardStaggerContainer className='grid items-stretch gap-4 xl:grid-cols-[minmax(0,1fr)_22rem]'>
          <CardStaggerItem className='bg-card shadow-card h-full overflow-hidden rounded-2xl border'>
          ...
          <CardStaggerItem className='bg-card shadow-card h-full rounded-2xl border p-4 sm:p-5'>
        ...
        <CardStaggerContainer>
          <CardStaggerItem className='bg-card shadow-card overflow-hidden rounded-2xl border'>
